...
RUN apt-get update 
RUN apt-get -y install supervisor apache2 php5 libapache2-mod-php5 php5-mcrypt mysql-server-5.6 libapache2-mod-auth-mysql php5-mysql curl php5-curl php5-intl php5-gd mcrypt php5-mcrypt
